...
class CommunityServiceTest {
    ...
    void pagelist() {
        ...
        PageRequestDTO dto = new PageRequestDTO(1,0,0,0,new String[]{"t","c"},"tc","공지",null,null);
//        PageRequestDTO dto = new PageRequestDTO(1,0,0,0,null,"tc","회원",null,null);        //view 에서 받는 type
